  ...
  return (
    <div>
        ...
        <div onClick={()=>{
          ...
          props.setConfirmedRidePanel(true)}} className='flex border-2 active:border-black border-xl rounded-xl w-full p-3  items-center justify-between mb-2'>
        ...
        <h2 className='text-xl font-semibold'>&#8377;{props.fareData.car}</h2>
      </div>
      ...
      <div onClick={()=>{
        ...
        <h2 className='text-xl font-semibold'>&#8377;{props.fareData.moto}</h2>
      </div>
       ...
       <div onClick={()=>{
        ...
        <h2 className='text-xl font-semibold'>&#8377;{props.fareData.auto}</h2>
      </div>
